...
def scatta_foto_precise():
    # Percorso della cartella GitHub
    ...
    try:
        ...
        # --- SCATTI STANDARD (PRONO&RISULTATI) ---
        ...
        # Foto CLASS2AFASE dinamica (in immagini_fisse)
        ...
        <head>
            ...
            <style>
                body {{ background-color: #121212; color: white; font-family: "AR CENA", sans-serif; text-align: center; margin: 0; padding: 10px; }}
                .settore-verde {{ border: 3px solid #00ff88; background: #0a0a0a; padding: 20px; border-radius: 15px; margin-bottom: 40px; }}
                
                /* Stile Titolo Richiesto */
                .titolo-container {{ color: #00ff88; text-shadow: 3px 3px #004422; line-height: 1.1; }}
                .titolo-riga1 {{ font-size: 45px; display: block; font-weight: bold; }}
                .titolo-riga2 {{ font-size: 24px; display: block; margin-top: 5px; }}

                .flex-top {{ display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; max-width: 1400px; margin: 0 auto; }}
                ...
                select {{ padding: 15px; border-radius: 8px; background: #1a1a1a; color: #00ff88; border: 2px solid #00ff88; font-size: 22px; width: 95%; max-width: 600px; }}
            </style>
        </head>
        <body>
            <div class="settore-verde">
                <h1 class="titolo-container">
                    <span class="titolo-riga1">🏆 16° TORNEO 🏆</span>
                    <span class="titolo-riga2">PRONOSTICI SERIE A - 2025/26</span>
                </h1>
            </div>
            ...
            <div class="settore-verde">
                ...
                <div class="flex-top" style="margin-top:20px;">
                    <div style="flex: 2; min-width: 320px;"><img src="{CARTELLA_FOTO_NOME}/risultati_partite.png?v={timestamp_url}" class="img-risultati"></div>
                    <div style="flex: 1; min-width: 320px;"><img src="{CARTELLA_FOTO_NOME}/foto_extra.png?v={timestamp_url}" class="img-extra"></div>
                </div>
            </div>
            ...
            <div style="border: 3px solid gold; background: #0a0a0a; padding: 30px; border-radius: 15px;">
                ...
                <div style="background: #1a1a00; padding: 25px; border-radius: 15px; border: 1px solid gold; margin-bottom: 40px; overflow-x: auto;">
                    <div style="display: flex; justify-content: center; align-items: flex-start; gap: 20px; min-width: 800px;">
                ...
                <div style="background: #1a1a00; padding: 25px; border-radius: 15px; border: 1px solid gold; margin-bottom: 40px;">
                    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
                        ...
                        <img src="foto_coppa_2.png?v={timestamp_url}" style="width: 50%; min-width: 320px; border: 2px solid #444;">
                    </div>
                </div>
                ...
                <div style="background: #1a1a00; padding: 25px; border-radius: 15px; border: 1px solid gold;">
                    <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: flex-start; gap: 20px;">
                        ...
                        <img src="foto_coppa_3.png?v={timestamp_url}" style="width: 65%; min-width: 320px; border: 2px solid gold; border-radius: 5px;">
                    </div>
                </div>
            </div>
